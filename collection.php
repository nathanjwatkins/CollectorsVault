...
.stat-value.is-gain{color:var(--acid);text-shadow:0 0 40px rgba(206,255,46,.18)}
...
.item-card:hover{border-color:rgba(206,255,46,.25);transform:translateY(-2px)}
...
.ic-badge{font-family:var(--mono);font-size:7px;letter-spacing:.06em;padding:1px 5px;border-radius:var(--radius);border:1px solid rgba(206,255,46,.20);background:rgba(206,255,46,.08);color:var(--acid);text-transform:uppercase}
...
.item-row:hover{border-color:rgba(206,255,46,.20)}
...
.fab:hover{box-shadow:0 0 40px rgba(206,255,46,.50),0 0 80px rgba(206,255,46,.20);transform:scale(1.06)}
...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   Palette: #0d0d0b void · #ceff2e acid · #FAFAFA white · #111116 surface
...
:root {
  ...
  /* Accent */
  --acid:      #ceff2e;
  --acid-dim:  rgba(206,255,46,.12);
  --acid-glow: 0 0 24px rgba(206,255,46,.30), 0 0 80px rgba(206,255,46,.10);
  --acid-glow-sm: 0 0 12px rgba(206,255,46,.25);
  --red:       #FF4444;
  --green:     #ceff2e;
...
.cv-nav-item.active {
  ...
  border-color: rgba(206,255,46,.18);
}
...
.cv-user-avatar {
  ...
  border-radius: 50%;
  background: var(--acid-dim);
  border: 1px solid rgba(206,255,46,.25);
  display: flex;
  align-items: center;
  justify-content: center;
  font-family: var(--mono);
...
.tag-acid {
  background: var(--acid-dim);
  border-color: rgba(206,255,46,.20);
  color: var(--acid);
}
...
.cv-input:focus {
  border-color: rgba(206,255,46,.35);
  box-shadow: 0 0 0 3px rgba(206,255,46,.07);
}
...
.cv-select:focus { border-color: rgba(206,255,46,.35); }
...
#toast {
  ...
  background: var(--surface);
  border: 1px solid rgba(206,255,46,.30);
  color: var(--acid);
  font-family: var(--mono);
  font-size: 10px;
  letter-spacing: .08em;
...
/* ── Selection ───────────────────────────────────────────────────────────── */
::selection { background: rgba(206,255,46,.20); color: var(--void); }
    ...
    list.map((c, i) => {
      ...
      return `
        <div onclick="pickEbayCandidate(${i})" data-cand-idx="${i}"
             ...
             onmouseover="this.style.borderColor='rgba(206,255,46,.45)'"
    ...
    return `<div>
      ...
      ${isTextarea
        ? `<textarea id="ef_${k}" rows="${k==='notes'?3:2}"
            ...
            onfocus="this.style.borderColor='rgba(206,255,46,.35)'"
