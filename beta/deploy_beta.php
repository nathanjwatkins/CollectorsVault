<?php
/**
 * CollectorVault Beta — Deploy webhook
 * Triggered by GitHub push to main, deploys only to /beta/
 */
...
if (($data['ref'] ?? '') !== 'refs/heads/main') {
    http_response_code(200); die('Not main branch');
}
...
$log   = [];
$log[] = date('Y-m-d H:i:s') . ' — Beta deploy triggered';
...
$log[] = 'Beta deploy complete.';
$log_text = implode("\n", $log) . "\n\n";
file_put_contents($deploy_dir . '/deploy_beta.log', $log_text, FILE_APPEND);
