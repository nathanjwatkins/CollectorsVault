...
?>
<nav>
  <a href="/beta/scanner.php" class="nav-logo">Collector<em>Vault</em></a>
  <div class="nav-divider"></div>
  <div class="nav-links">
    <a href="/beta/scanner.php" class="nav-link <?= $page === 'scanner' ? 'active' : '' ?>">
    ...
    <a href="/beta/collection.php" class="nav-link <?= $page === 'collection' ? 'active' : '' ?>">
  ...
  <div class="nav-right">
    ...
    <a href="/beta/logout.php" class="sign-out-btn">
...
<nav class="bottom-nav">
  <a href="/beta/scanner.php" class="bn-item <?= $page === 'scanner' ? 'active' : '' ?>">
    <svg viewBox="0 0 24 24"><path d="M3 7V5a2 2 0 012-2h2M17 3h2a2 2 0 012 2v2M21 17v2a2 2 0 01-2 2h-2M7 21H5a2 2 0 01-2-2v-2"/><rect x="9" y="9" width="6" height="6" rx="1"/></svg>
    Scan
  </a>
  <a href="/beta/collection.php" class="bn-item <?= $page === 'collection' ? 'active' : '' ?>">
    <svg viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
    Collection
  </a>
</nav>
